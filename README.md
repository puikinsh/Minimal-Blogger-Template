...
1. **Download** — [Download the ZIP](https://github.com/puikinsh/Minimal-Blogger-Template/archive/refs/heads/master.zip) or clone this repository
...
Minimal is free for both personal and commercial use. You are free to modify and redistribute the template. Attribution to [Colorlib](https://colorlib.com) is appreciated but not required.

## More Free Templates by Colorlib

- [Free Blogger Templates](https://colorlib.com/wp/free-blogger-templates/) — the best free Blogger/Blogspot templates for every niche
- [Free WordPress Themes](https://colorlib.com/wp/free-wordpress-themes/) — responsive, mobile-friendly WordPress themes
- [Free HTML Website Templates](https://colorlib.com/wp/templates/) — Bootstrap-based HTML templates
